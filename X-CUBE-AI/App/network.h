...
#define AI_NETWORK_IN_1_HEIGHT      (48)
#define AI_NETWORK_IN_1_WIDTH       (10)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (480)
#define AI_NETWORK_IN_1_SIZE_BYTES  (1920)
...
#define AI_NETWORK_OUT_1_SIZE        (30)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (120)
