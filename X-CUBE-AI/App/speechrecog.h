/**
  ...
  ******************************************************************************
  */
#ifndef AI_SPEECHRECOG_H
#define AI_SPEECHRECOG_H

#include "speechrecog_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SPEECHRECOG_MODEL_NAME          "speechrecog"
#define AI_SPEECHRECOG_ORIGIN_MODEL_NAME   "kws_model"

/******************************************************************************/
#define AI_SPEECHRECOG_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SPEECHRECOG_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SPEECHRECOG_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SPEECHRECOG_IN_NUM        (1)

AI_DEPRECATED
#define AI_SPEECHRECOG_IN \
  ai_speechrecog_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECHRECOG_IN_SIZE { \
  AI_SPEECHRECOG_IN_1_SIZE, \
}
#define AI_SPEECHRECOG_IN_SIZE_BYTES { \
  AI_SPEECHRECOG_IN_1_SIZE_BYTES, \
}
#define AI_SPEECHRECOG_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SPEECHRECOG_IN_1_HEIGHT      (48)
#define AI_SPEECHRECOG_IN_1_WIDTH       (10)
#define AI_SPEECHRECOG_IN_1_CHANNEL     (1)
#define AI_SPEECHRECOG_IN_1_SIZE        (480)
#define AI_SPEECHRECOG_IN_1_SIZE_BYTES  (1920)

/******************************************************************************/
#define AI_SPEECHRECOG_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SPEECHRECOG_OUT \
  ai_speechrecog_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECHRECOG_OUT_SIZE { \
  AI_SPEECHRECOG_OUT_1_SIZE, \
}
#define AI_SPEECHRECOG_OUT_SIZE_BYTES { \
  AI_SPEECHRECOG_OUT_1_SIZE_BYTES, \
}
#define AI_SPEECHRECOG_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SPEECHRECOG_OUT_1_CHANNEL     (30)
#define AI_SPEECHRECOG_OUT_1_SIZE        (30)
#define AI_SPEECHRECOG_OUT_1_SIZE_BYTES  (120)

/******************************************************************************/
#define AI_SPEECHRECOG_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup speechrecog
 ...
 * @ref ai_speechrecog_create. Both the activations memory buffer 
 ...
 * using @ref ai_speechrecog_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speechrecog_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speechrecog_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SPEECHRECOG_*
 * defines into file @ref speechrecog.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_speechrecog_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SPEECHRECOG_H */
